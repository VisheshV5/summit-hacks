...
export default function Analytics() {
  ...
  const [cExpanded, setCExpanded] = useState(true);
  const [iExpanded, setIExpanded] = useState(true);
          ...
          <Slider ref={setSliderRef} {...sliderSettings}>
            <Box sx={{ width: "10%", margin: "auto" }}>
              {Object.keys(averageAccuracy)
                ...
                .map((subject) => (
                  <>
                    <h1 style={{ marginTop: 50, textTransform: "capitalize" }}>
                      {subject} Quiz
                    </h1>
                    ...
                    >
                      ...
                      <Grid item xs={6}>
                        {averageAccuracy[subject].correctQuestions.length >
                          0 && (
                          <Box
                            sx={{
                              p: 3,
                        ...
                        {averageAccuracy[subject].incorrectQuestions.length >
                          0 && (
                          <Box
                            sx={{
                              p: 3,
                                  ...
                                  {averageAccuracy[subject].incorrectQuestions
                                    .filter((question) =>
                                      question.question
                                        .toLowerCase()
                                        .includes(
                                          incorrectSearchTerm.toLowerCase()
                                        )
                                    )
                                    .slice(
