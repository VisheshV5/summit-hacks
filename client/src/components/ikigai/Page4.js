  ...
  return (
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          Going back to the previous page will erase your progress? Do you want
        ...
        <Modal.Footer>
          ...
          >
            <button className="btn-secondary btn-lg">Yes</button>
          </Link>
        </Modal.Footer>
      </Modal>
        ...
        <div className="page-content">
          ...
          >
            <div className="main-header-text">
              ...
              <br />
              <p>
                Start by adding activites or values you are currently doing into
